...
class SinginBotanistePage extends StatefulWidget {
  @override
  _SinginBotanistePageState createState() => _SinginBotanistePageState();
}

class _SinginBotanistePageState extends State<SinginBotanistePage> {
