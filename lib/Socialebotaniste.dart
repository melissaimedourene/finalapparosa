...
import 'package:monapplicationarosaje/login-pagebotaniste.dart';
import 'package:monapplicationarosaje/signin_pagebotaniste.dart';
class SocialPagebotaniste extends StatelessWidget {
  @override
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => BotanistLoginPage(),
                            ),
                          );
                        },
                      ),
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => SinginBotanistePage(),
                            ),
                          );
                        },
                      ),
